  ...
  const carregar = useCallback(async () => {
    ...
    try {
      ...
      if (r.ok && Array.isArray(d)) {
        setItens(
          d.map((x: { id: string; medicamento: string; doseDescricao?: string; dose_descricao?: string; receitaTipo?: string | null; receita_tipo?: string; criadaEm?: string; criada_em?: string }) => ({
            id: x.id,
