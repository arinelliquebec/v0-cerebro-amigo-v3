// CA bundle da AWS RDS sa-east-1 (https://truststore.pki.rds.amazonaws.com/sa-east-1/sa-east-1-bundle.pem).
// Usado p/ verificar a cadeia + hostname do RDS (ssl verify-full — CK-3, anti-MITM).
// Atualizar quando a AWS rotacionar as CAs regionais.
export const RDS_CA_SA_EAST_1 = `-----BEGIN CERTIFICATE-----
