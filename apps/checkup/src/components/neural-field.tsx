 ...
 * sinapses que pulsam e reagem ao cursor. É o MESMO efeito da página de login
 * do site principal (apps/web), portado verbatim para a home do checkup.
 *
 * Isolamento (apps/checkup/CLAUDE.md): componente puro de apresentação — só
 * React + Canvas 2D, zero dado, zero import de serviço clínico. Cópia (não
 * import) do web → fronteira preservada.
 *
